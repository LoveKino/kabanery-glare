...
/*!*****************************************************************************************!*\
  !*** /Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/Checkbox.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("const glareView = __webpack_require__(/*! ../util/glareView */ \"../../src/util/glareView.js\");\n\n/**\n * <Badge>\n *   <Child></Child>\n * </Badge>\n */\nmodule.exports = glareView(({\n  props,\n  onChange,\n  onEvent,\n  n\n}, ctx) => {\n  return n('label', {\n    style: props.style.box,\n    onclick: (e) => {\n      e.preventDefault();\n\n      props.checked = !props.checked;\n      onChange(props, ctx, e);\n      ctx.update();\n\n      onEvent({\n        type: 'click',\n        sourceEvent: e\n      });\n    }\n  }, [\n    n('span', {\n      style: props.style.checkbox[props.color][props.checked ? 'checked' : 'unchecked']\n    }, [\n      n('input', {\n        type: 'checkbox',\n        value: props.checked,\n        style: {\n          margin: 0,\n          padding: 0,\n          position: 'absolute',\n          left: 0,\n          top: 0,\n          height: '100%',\n          opacity: '0'\n        }\n      }),\n      n('span', {\n        style: {\n          left: 4,\n          top: -1,\n          width: 5,\n          height: 10,\n          display: 'block',\n          border: 'solid white',\n          'border-width': '0 2px 2px 0',\n          '-webkit-transform': 'rotate(45deg)',\n          '-ms-transform': 'rotate(45deg)',\n          'transform': 'rotate(45deg)',\n          position: 'absolute'\n        }\n      })\n    ]),\n\n    n('span', {\n      style: props.style.label\n    }, [props.label])\n  ]);\n}, {\n  id: 'Checkbox',\n  defaultProps: {\n    color: 'default',\n    checked: false\n  }\n});\n\n\n//# sourceURL=webpack:////Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/Checkbox.js?");

/***/ }),

/***/ "../../src/base/Divider.js":
/*!****************************************************************************************!*\
  !*** /Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/Divider.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("const glareView = __webpack_require__(/*! ../util/glareView */ \"../../src/util/glareView.js\");\n\nmodule.exports = glareView(({\n  props,\n  n\n}) => {\n  return n('hr', {\n    style: props.style\n  });\n}, {\n  id: 'Divider',\n  defaultProps: {}\n});\n\n\n//# sourceURL=webpack:////Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/Divider.js?");

/***/ }),

/***/ "../../src/base/Row.js":
/*!************************************************************************************!*\
  !*** /Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/Row.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("const glareView = __webpack_require__(/*! ../util/glareView */ \"../../src/util/glareView.js\");\n\n/**\n * Row: distribute children in a row\n *\n * <Row>\n *   <RowLeftAlign>\n *     <Text>1</Text>\n *     <Text>2</Text>\n *   <RowLeftAlign/>\n *   <RowCenterAlign>\n *     <Text>3</Text>\n *     <Text>4</Text>\n *   <RowCenterAlign/>\n *   <RowRightAlign>\n *     <Text>5</Text>\n *     <Text>6</Text>\n *   <RowRightAlign/>\n * </Row>\n */\n\nconst Row = glareView(({\n  props,\n  n,\n  children\n}) => {\n  return n('div', {\n    style: props.style.box\n  }, [children]);\n}, {\n  id: 'Row',\n  defaultProps: {}\n});\n\nconst RowLeftAlign = glareView(({\n  props,\n  n,\n  children\n}) => {\n  return n('div', {\n    style: props.style.box\n  }, [children]);\n}, {\n  id: 'RowLeftAlign'\n});\n\nmodule.exports = {\n  Row,\n  RowLeftAlign\n};\n\n\n//# sourceURL=webpack:////Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/Row.js?");

/***/ }),

/***/ "../../src/base/Text.js":
/*!*************************************************************************************!*\
  !*** /Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/Text.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("const glareView = __webpack_require__(/*! ../util/glareView */ \"../../src/util/glareView.js\");\n\nmodule.exports = glareView(({\n  props,\n  n,\n  children\n}) => {\n  if (props.type === 'default') {\n    return n('span', {\n      style: props.style[props.type]\n    }, children);\n  } else if (props.type === 'h2') {\n    return n('h2', {\n      style: props.style[props.type]\n    }, children);\n  } else {\n    throw new Error(`unexpect Text type ${props.type}`);\n  }\n}, {\n  id: 'Text',\n  defaultProps: {\n    type: 'default'\n  }\n});\n\n\n//# sourceURL=webpack:////Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/Text.js?");
...
/***/ "../../src/base/br.js":
/*!***********************************************************************************!*\
  !*** /Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/br.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("const glareView = __webpack_require__(/*! ../util/glareView */ \"../../src/util/glareView.js\");\n\nmodule.exports = glareView(({\n  props,\n  n\n}) => {\n  return n('br', {\n    style: props.style\n  });\n}, {\n  id: 'Br',\n  defaultProps: {}\n});\n\n\n//# sourceURL=webpack:////Users/yuer/workspaceforme/ddki/tech/base/web/kabanery-glare/src/base/br.js?");
...
eval("const TextField = __webpack_require__(/*! ../../src/base/TextField */ \"../../src/base/TextField.js\");\nconst Text = __webpack_require__(/*! ../../src/base/Text */ \"../../src/base/Text.js\");\nconst {\n  Row,\n  // RowLeftAlign\n} = __webpack_require__(/*! ../../src/base/Row */ \"../../src/base/Row.js\");\nconst Br = __webpack_require__(/*! ../../src/base/br */ \"../../src/base/br.js\");\nconst Button = __webpack_require__(/*! ../../src/base/Button */ \"../../src/base/Button.js\");\nconst Divider = __webpack_require__(/*! ../../src/base/Divider */ \"../../src/base/Divider.js\");\nconst Badge = __webpack_require__(/*! ../../src/base/Badge */ \"../../src/base/Badge.js\");\nconst Checkbox = __webpack_require__(/*! ../../src/base/Checkbox */ \"../../src/base/Checkbox.js\");\nconst {\n  glareView\n} = __webpack_require__(/*! ../../src */ \"../../src/index.js\");\nconst {\n  mount,\n  n\n} = __webpack_require__(/*! kabanery */ \"./node_modules/kabanery/index.js\");\nconst log = console.log; // eslint-disable-line\n\nconst IntroduceView = glareView(({\n  props,\n  n,\n  children\n}) => {\n  return n('div', [\n    n(Text, {\n      props: {\n        type: 'h2',\n      }\n    }, props.title),\n    n(Br),\n    children\n  ]);\n}, {});\n\nconst Page = glareView(({\n  props,\n  n,\n  bn\n}) => {\n  return n('p', [\n    n(IntroduceView, {\n      props: {\n        title: 'TextField'\n      }\n    }, [\n      // text field\n      bn(TextField, {\n        propsPath: 'name',\n        doUpdate: true\n      }),\n      n(Br),\n      n(Text, `${props.name.value}`),\n    ]),\n\n    // buttons\n    n(Row, [\n      bn(Button, {\n        propsPath: 'button1',\n        onChildEvent: (e) => e.type === 'click' && log(e.type)\n      }, 'default button'),\n      bn(Button, {\n        propsPath: 'button2',\n        onChildEvent: (e) => e.type === 'click' && log(e.type)\n      }, 'primary button'),\n      bn(Button, {\n        propsPath: 'button3',\n        onChildEvent: (e) => e.type === 'click' && log(e.type)\n      }, 'secondary button'),\n\n      bn(Button, {\n        propsPath: 'button4',\n        onChildEvent: (e) => e.type === 'click' && log(e.type)\n      }, 'default button'),\n\n      bn(Button, {\n        propsPath: 'button5',\n        onChildEvent: (e) => e.type === 'click' && log(e.type)\n      }, 'primary button'),\n      bn(Button, {\n        propsPath: 'button6',\n        onChildEvent: (e) => e.type === 'click' && log(e.type)\n      }, 'secondary button'),\n    ]),\n\n    n('br'),\n    n('br'),\n\n    // divider\n    bn(Divider, {\n      propsPath: 'divider'\n    }),\n\n    // badge\n    bn(Badge, {\n      propsPath: 'badge1'\n    }, [\n      bn(Button, {\n        propsPath: 'badge1-test-button'\n      }, 'badge button')\n    ]),\n\n    bn(Badge, {\n      propsPath: 'badge2'\n    }, [\n      bn(Button, {\n        propsPath: 'badge2-test-button'\n      }, 'badge button')\n    ]),\n\n    // checkbox\n    bn(Checkbox, {\n      propsPath: 'checkbox1'\n    }),\n    bn(Checkbox, {\n      propsPath: 'checkbox2'\n    }),\n    bn(Checkbox, {\n      propsPath: 'checkbox3'\n    })\n  ]);\n});\n\nmount(n('div', [\n  Page({\n    props: {\n      name: {\n        value: '',\n        placeholder: 'Test'\n      },\n      button1: {},\n      button2: {\n        color: 'primary'\n      },\n      button3: {\n        color: 'secondary'\n      },\n      button4: {\n        type: 'contained'\n      },\n      button5: {\n        color: 'primary',\n        type: 'contained'\n      },\n      button6: {\n        color: 'secondary',\n        type: 'contained'\n      },\n      badge1: {\n        content: '4'\n      },\n      'badge1-test-button': {\n        color: 'primary',\n        type: 'contained'\n      },\n      badge2: {\n        content: '10',\n        color: 'secondary'\n      },\n      'badge2-test-button': {\n        color: 'primary'\n      },\n\n      'checkbox1': {\n        label: 'default',\n        checked: true\n      },\n      'checkbox2': {\n        label: 'primary',\n        color: 'primary',\n        checked: true\n      },\n      'checkbox3': {\n        label: 'secondary',\n        color: 'secondary',\n        checked: true\n      }\n    }\n  })\n]), document.body);\n\n\n//# sourceURL=webpack:///./index.js?");
